...
![](assets/image-20230422123005653.png)
...
![](assets/image-20230422123421018.png)
...
![Metasploit - post/linux/gather/enum_configs](assets/image-20230422123734142.png)
...
![Metasploit - post/multi/gather/env](assets/image-20230422124555124.png)
...
![Metasploit - post/linux/gather/enum_network](assets/image-20230422124816182.png)
...
![Metasploit - post/linux/gather/enum_protections](assets/image-20230422125210727.png)
...
![Metasploit - post/linux/gather/enum_system](assets/image-20230422125507452.png)
...
![Metasploit - post/linux/gather/checkcontainer](assets/image-20230422125830993.png)
...
![Metasploit - post/linux/gather/checkvm](assets/image-20230422130151548.png)
...
![Metasploit - post/linux/gather/enum_users_history](assets/image-20230422130408774.png)
...
![](assets/image-20230422133205452.png)

```bash
ps aux
```

![ps aux](assets/image-20230422133341465.png)
...
![cat /bin/check-down](assets/image-20230422133438780.png)
...
![exploit/unix/local/chkrootkit](assets/image-20230422134736591.png)
...
![](assets/image-20230422134925689.png)
...
![Metasploit - post/linux/gather/hashdump](assets/image-20230422144950444.png)

![loot](assets/image-20230422145236520.png)
...
![Metasploit - post/multi/gather/ssh_creds](assets/image-20230422145010635.png)
...
![Metasploit - post/linux/gather/ecryptfs_creds](assets/image-20230422150125356.png)
...
![Metasploit - post/linux/gather/enum_psk](assets/image-20230422152033281.png)
...
![Metasploit - post/linux/gather/pptpd_chap_secrets](assets/image-20230422152700235.png)
...
![Metasploit - post/linux/manage/sshkey_persistence](assets/image-20230422152922123.png)
...
![](assets/image-20230422164900736.png)
...
![Metasploit - post/linux/manage/sshkey_persistence](assets/image-20230422165505058.png)
...
![ssh -i ssh_key root@<TARGET_IP>](assets/image-20230422170517426.png)
